...
export default function WhatsAppFAB() {
  ...
  const contacts = [
    { name: "Gilson", wa: "https://wa.me/34693976311" },
    { name: "Paul", wa: "https://wa.me/34612266321" },
  ];
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        {open && (
          <>
            {contacts.map((c, i) => (
              <motion.a
                key={c.name}
                href={`${c.wa}?text=${encodeURIComponent("Hola! Me interesa conocer más sobre vuestros servicios en Torrevieja.")}`}
                target="_blank"
                ...
                className="flex items-center gap-3 bg-white shadow-xl rounded-2xl px-4 py-3 border border-slate-100 hover:border-green-200 hover:shadow-2xl transition-all group"
              >
      ...
      <motion.button
        ...
        className="w-16 h-16 bg-[#25D366] hover:bg-green-500 rounded-full shadow-2xl flex items-center justify-center transition-colors"
        aria-label="WhatsApp"
      >
